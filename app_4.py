...
mydb = sql.connect(host="localhost", user="admin", password="12345", database="youtubedata1")
mycursor = mydb.cursor(buffered=True)

# BUILDING CONNECTION WITH YOUTUBE API
api_key = "AIzaSyCkglXpsoXo7QjsLDBAL8mzCfX4YZzpdtg" #AIzaSyDhosKCf4f3RbhUNrixXPqJ41O8Mr3CODQ
